...
**Scoundrel** is a web-based implementation of the solo dungeon-crawler card game designed by Zach Gage and Kurt Bieg. Built with React and Vite, it features a high-end "Dark Dungeon" aesthetic and precise gameplay mechanics.
